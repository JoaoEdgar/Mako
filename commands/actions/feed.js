...
module.exports = {
	...
	async execute(message, args, client) {
        ...
        .setTitle("Opa")
        .setDescription(`O bot da panelinha alimentou ${message.author} :open_mouth:  `)
        .setImage(body.url);
        ...
        .setTitle("Opa")
        .setDescription(`${message.author} alimentou ${user}! :open_mouth: `)
        .setImage(body.url);
